...
define('BASEPATH'     , IS_LOCAL ? '/sistemaLikes/' : '____EL BASEPATH EN PRODUCCIÓN___'); // Debe ser cambiada a la ruta de tu proyecto en producción y desarrollo
...
define('AUTH_SALT'    , 'MeGusta2021<3');
